...
// QUESTION - what is the work-factor proved used for?
...
pub fn work_factor_proved(size: u64, ttl: EnvelopeTTLDuration, hash: EnvelopeProvingHash) -> EnvelopeProvenWork {
	...
	let leading_zeros = {
		// QUESTION - what is double ampersand `&&`
...
// Raw envelope struct. Each message struct contains an instance of an envelope.
...
impl Envelope {
	...
	fn proving_hash(&self) -> EnvelopeProvingHash {
		...
		// TODO - this code is repeated in Message create start_digest. can we reuse it?
		// and what is the difference between what they do?
...
impl Message {
		...
		-> Result<Self, Error>
	{
		...
		// QUESTION - `issue_time_adjusted` isn't mutable, why can we redeclare and mutate it below
		...
		// FIXME - is this required to be a a Github issue?
